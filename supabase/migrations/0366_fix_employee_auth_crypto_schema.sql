-- 0366_fix_employee_auth_crypto_schema.sql
-- Fix SECURITY DEFINER search_path issue: pgcrypto functions live in schema "extensions" on Supabase.
...
begin
  ...
  -- IMPORTANT: pgcrypto is installed into schema "extensions" on Supabase
