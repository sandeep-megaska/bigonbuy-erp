-- Fix: ensure erp_vendor_portal_enable ALWAYS returns a row (so API doesn't return {data:null})
-- Also avoid ambiguous column refs by qualifying outputs with aliases in final SELECT.
