-- 0338_razorpay_settlement_csv_utr_fix.sql
-- Phase 2F.2: Map Razorpay CSV UTR fields correctly during import
...
begin
  ...
  loop
    ...
    if v_reason is null then
      ...
      v_utr := nullif(trim(coalesce(v_row->>'utr', v_row->>'bank_utr', v_row->>'settlement_utr', '')), '');
    ...
    do update set
      settlement_utr = coalesce(public.erp_razorpay_settlements.settlement_utr, excluded.settlement_utr),
      utr = coalesce(public.erp_razorpay_settlements.utr, excluded.utr),
