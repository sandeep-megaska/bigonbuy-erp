-- 0263_fix_gst_shopify_discount_allocation.sql
-- Ensure Shopify GST regeneration applies discount allocations to taxable values
...
begin
  ...
  calc_total as (
    select
      pricing.*,
      greatest(0, round(pricing.line_gross - pricing.line_discount, 2)) as line_taxable,
      sum(greatest(0, round(pricing.line_gross - pricing.line_discount, 2)))
  ...
  select
    ...
    jsonb_build_object(
      ...
      'line_discount', taxcalc.line_discount,
