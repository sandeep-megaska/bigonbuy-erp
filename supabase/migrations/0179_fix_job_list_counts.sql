...
create or replace function public.erp_channel_job_list_with_counts(
  p_channel_account_id uuid,
  p_job_type text default null,
  p_status text default null,
  p_limit int default 50,
...
revoke all on function public.erp_channel_job_list_with_counts(uuid, text, text, int, int) from public;
grant execute on function public.erp_channel_job_list_with_counts(uuid, text, text, int, int) to authenticated;
