-- 0235_fix_erp_post_grn_set_legacy_qty.sql
-- Fix erp_post_grn(): ensure legacy qty (NOT NULL) is populated.
...
begin
  ...
  -- Ledger posting: populate BOTH new columns and legacy qty/type/ref
  insert into public.erp_inventory_ledger (
    ...
    -- Legacy compatibility (still NOT NULL in your schema)
    qty,
    type,
    ref,
