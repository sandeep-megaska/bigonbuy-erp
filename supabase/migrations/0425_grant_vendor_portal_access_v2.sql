-- 0425_grant_vendor_portal_access_v2.sql
-- Adds company_id to grant access RPC response for downstream password reset flow.

create or replace function public.erp_grant_vendor_portal_access_v2(
  p_vendor_id uuid,
  p_email text,
  p_role_key text,
  p_auth_user_id uuid
...
revoke all on function public.erp_grant_vendor_portal_access_v2(uuid, text, text, uuid) from public;
grant execute on function public.erp_grant_vendor_portal_access_v2(uuid, text, text, uuid) to authenticated;
