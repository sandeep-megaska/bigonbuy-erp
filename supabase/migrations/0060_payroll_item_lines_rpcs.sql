-- Payroll item line RPCs and recalculation

create or replace function public.erp_payroll_item_lines_list(
...
create or replace function public.erp_payroll_item_recalculate(
  p_payroll_item_id uuid
) returns void
language plpgsql
security definer
