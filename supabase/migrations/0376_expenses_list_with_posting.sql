-- 0376_expenses_list_with_posting.sql
-- Canonical expenses list with finance posting status (Posted/Missing/Excluded) + journal link.
-- Prevents UI drift by making posting state DB-truth.
...
begin
  ...
  with base as (
    select
      ...
      -- Exclusion rule must match your posting function guardrails
      (
    ...
    left join public.erp_channels ch
